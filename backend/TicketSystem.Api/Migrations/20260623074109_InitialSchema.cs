        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPrimarySPOC = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationAssignments_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationId = table.Column<int>(type: "int", nullable: false),
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
                    PrimarySpocUserId = table.Column<int>(type: "int", nullable: false),
                    BackupSpocUserId = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationRoutingRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationRoutingRules_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationRoutingRules_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationRoutingRules_Users_BackupSpocUserId",
                        column: x => x.BackupSpocUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ApplicationRoutingRules_Users_PrimarySpocUserId",
                        column: x => x.PrimarySpocUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_Requesters_RequesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailMessages_Requesters_RequesterId",
                        column: x => x.RequesterId,
                        principalTable: "Requesters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketCorrectiveActions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketCorrectiveActions_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketCorrectiveActions_Users_PerformedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequesterId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: true),
                    MessageSourceType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedByRequesterId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketStatusHistory_Requesters_ChangedByRequesterId",
                        column: x => x.ChangedByRequesterId,
                        principalTable: "Requesters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TicketStatusHistory_TicketStatuses_FromStatusId",
                        column: x => x.FromStatusId,
                        principalTable: "TicketStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TicketStatusHistory_TicketStatuses_ToStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationAssignments_UserId_ApplicationId",
                table: "ApplicationAssignments",
                columns: new[] { "UserId", "ApplicationId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRoutingRules_ApplicationId_DepartmentId",
                table: "ApplicationRoutingRules",
                columns: new[] { "ApplicationId", "DepartmentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRoutingRules_BackupSpocUserId",
                table: "ApplicationRoutingRules",
                column: "BackupSpocUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRoutingRules_DepartmentId",
                table: "ApplicationRoutingRules",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRoutingRules_PrimarySpocUserId",
                table: "ApplicationRoutingRules",
                column: "PrimarySpocUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailMessages_RequesterId",
                table: "EmailMessages",
                column: "RequesterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketCorrectiveActions_PerformedByUserId",
                table: "TicketCorrectiveActions",
                column: "PerformedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketCorrectiveActions_TicketId",
                table: "TicketCorrectiveActions",
                column: "TicketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketMessages_RequesterId",
                table: "TicketMessages",
                column: "RequesterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketStatusHistory_ChangedByRequesterId",
                table: "TicketStatusHistory",
                column: "ChangedByRequesterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketStatusHistory_ToStatusId",
                table: "TicketStatusHistory",
                column: "ToStatusId");
